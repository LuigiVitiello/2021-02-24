...
public class PremierLeagueDAO {
	...
	public void listAllPlayers(Map<Integer, Player> idMap){
		String sql = "SELECT p.PlayerID, p.Name, a.TeamID FROM Players p, Actions a WHERE a.PlayerID=p.PlayerID";
	...
	public void listAllTeams(Map<Integer, Team> mapSquadre){
		...
		try {
			...
			while (res.next()) {
				...
				if(!mapSquadre.containsKey(res.getInt("TeamID"))) {
				Team team = new Team(res.getInt("TeamID"), res.getString("Name"));
				mapSquadre.put(res.getInt("TeamID"), team);
				}
			}
			conn.close();
